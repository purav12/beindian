...
namespace WebgapeClass
{
    ...
    {  
        ...
        public SQLAccessChips()
        {
            conn = new SqlConnection(System.Configuration.ConfigurationSettings.AppSettings["Chipsseller_Ecomm_DBEntities"]);
        }
        ...
        public bool ExecuteNonQuery(string Query)
        {
            ...
            catch (Exception ex)
            {
                ...
                CommonDAC.ErrorLog("SQLAccessChips.cs", ex.Message, ex.StackTrace);
            }
            finally
            {
                if (conn != null)
        ...
        public Object ExecuteNonQuery(SqlCommand cmd)
        {
            ...
            catch (Exception ex)
            {
                ...
                CommonDAC.ErrorLog("SQLAccessChips.cs", ex.Message, ex.StackTrace + "Query-" + cmd.CommandText.ToString() + "-OrgQuery " + Query);
            }
            finally
            {
                if (conn != null)
