<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PopularPost.aspx.cs" Inherits="Webgape.PopularPost" %>
    ...
    <script type="text/javascript">
        ...
        function Load() {
            ...
            if (totalpoststodisplay <= Take && flagin == 0) {
                $('#ContentPlaceHolder1_Div' + parseInt(divcount.value)).load("/scrolling.aspx?Popular=true&skip=" + Skip + "&take=" + Take, function (response, status, xhr) {
                    if (status == "error") {
    ...
    <div class="wrapper">
       <div style="margin-bottom:5px">
        ...
        <h1 class="title" style="text-align: center;">
            <asp:Literal Text="Popular Posts" runat="server"></asp:Literal>
        </h1>
        <div class="blog-wrap">
