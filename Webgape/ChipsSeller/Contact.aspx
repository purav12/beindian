<%@ Page Title="" Language="C#" MasterPageFile="~/ChipsSeller/ChipsSeller.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Webgape.ChipsSeller.Contact" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Chips Seller India Contact - BeIndian.in</title>
    <meta name="description" content="Chips Seller India Contact - BeIndian.in" />
    <meta name="keywords" content="Chips Seller India Contact, Chips Seller India on BeIndian.in, BeIndian.in" />
    <style type="text/css">
        .Commnettext {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapper">
        <div class="content box">
            <h1 class="title">Contact - Chips Seller India</h1>
            <div class="map">
        ...
        <div class="sidebar box">
            <div class="sidebox widget">
                ...
                <p>
                    <span class="lite1">Facebook:</span>&nbsp; <a href="https://facebook.com/pokerking1212" target="_blank"><u>https://facebook.com/pokerking1212</u></a><br />
                    ...
                    <br>
                    <span class="lite1">Page Admin:</span>&nbsp; <a href="mailto:puravmehta1212@yahoo.com?Subject=Contact%20Us" target="_blank"><u>puravmehta1212@yahoo.com</u></a>
                </p>
            </div>
            <div class="sidebox widget">
