...
{
    public partial class ChipsSeller : System.Web.UI.MasterPage
    {
        #region Declaration
        ...
        public void BindActiveMenu()
        {
            ...
            else if (Request.Url.ToString().ToLower().IndexOf("profile.aspx") > -1)
            {
                licontact.Attributes.Add("class", "");
                lihome.Attributes.Add("class", "");
                liprofile.Attributes.Add("class", "active");
                liidlist.Attributes.Add("class", "");
            }
            else if (Request.Url.ToString().ToLower().IndexOf("id.aspx") > -1)
            {
                licontact.Attributes.Add("class", "");
                lihome.Attributes.Add("class", "");
                liprofile.Attributes.Add("class", "");
                liidlist.Attributes.Add("class", "active");
            }
        }
        ...
        public void BindStaticData()
        {
            ...
            dsTopicData = Topicclass.GetTopicList("ChipssellerIndexPageWelcomeText");
        ...
        private void AddSiteConfig()
        {
            ...
            {
                HeadTitle("Chips Seller India - BeIndian.in", "Chips Seller India, BeIndian.in, Zynga Chips India", "Chips Seller India's page on BeIndian.in");
            }
        }
