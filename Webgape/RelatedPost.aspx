<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RelatedPost.aspx.cs" Inherits="Webgape.RelatedPost" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Load() {
            ...
            var PostId = <%= new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(Request.QueryString["PostId"]) %>;
     
            if (totalpoststodisplay <= Take && flagin == 0) {
                $('#ContentPlaceHolder1_Div' + parseInt(divcount.value)).load("/scrolling.aspx?Related=true&PostId=" + PostId + "&skip=" + Skip + "&take=" + Take, function (response, status, xhr) {
                    if (status == "error") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="wrapper">
        ...
        <h1 class="title" style="text-align: center;">
            <asp:Literal Text="Related Posts" runat="server"></asp:Literal>
        </h1>
        <div class="blog-wrap">
