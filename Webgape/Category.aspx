<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Webgape.Category" %>
    ...
    <script type="text/javascript">
        ...
        function Load() {
            ...
            if (totalpoststodisplay <= Take && flagin == 0) {
                $('#ContentPlaceHolder1_divscrollpost').load("/scrolling.aspx?catid=" + catid + "&postid=" + postid + "&searchvalue=" + txtsearch + "&skip=" + Skip + "&take=" + Take, function (response, status, xhr) {
                    if (status == "error") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="wrapper" runat="server">
        ...
        <h1 class="title" style="text-align: center;">
            <asp:Literal ID="ltrcatttitle" runat="server"></asp:Literal>
        </h1>
        <div runat="server" id="divsubcat">
            <div class="wrapper" style="overflow: auto;" runat="server">
                <hr />
            </div>
            <h2 class="title">
                <asp:Label ID="lblsubcategorytitle" runat="server"></asp:Label>
            </h2>
            <div class="box">
    ...
    <div class="wrapper" runat="server" style="overflow: auto;">
        <h2 class="title">
