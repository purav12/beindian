...
var tree_data = {
	'Categories-Name' : {name: 'Categories Name', type: 'folder'}	,
	'CategoriesName' : {name: 'Categories Name', type: 'folder'}	,
	'CategoriesName1' : {name: 'Categories Name', type: 'item'}	,
	'CategoriesName2' : {name: 'Categories Name', type: 'item'}	,
	'CategoriesName3' : {name: 'Categories Name', type: 'item'}
}
tree_data['Categories-Name']['additionalParameters'] = {
	'children' : {
		'Categories-Name1' : {name: 'Categories Name', type: 'item'},
		'Categories-Name2' : {name: 'Categories Name', type: 'item'},
		'Categories-Name3' : {name: 'Categories Name', type: 'item'},
		'Categories-Name4' : {name: 'Categories Name', type: 'item'},
		'Categories-Name5' : {name: 'Categories Name', type: 'item'},
		'Categories-Name6' : {name: 'Categories Name', type: 'item'},
		'Categories-Name7' : {name: 'Categories Name', type: 'item'}
	}
}
tree_data['CategoriesName']['additionalParameters'] = {
	'children' : {
		'CategoriesName1' : {name: 'Categories Name', type: 'item'},
		'CategoriesName2' : {name: 'Categories Name', type: 'item'},
		'CategoriesName3' : {name: 'Categories Name', type: 'item'}
