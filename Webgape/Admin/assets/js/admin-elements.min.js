jQuery(function () {
    ...
    window.style.click_event = $.fn.tap ? "tap" : "click"
});
(function (e, c) {
    ...
    var f = function (l, m) {
        var k = this;
        this.settings = e.extend({}, e.fn.style_file_input.defaults, m);
        this.$element = e(l);
        this.element = l;
        this.disabled = false;
        this.can_reset = true;
        this.$element.on("change.style_inner_call", function (o, n) {
            if (n === true) {
                return
            }
            return a.call(k)
        });
        this.$element.wrap('<div class="style-file-input" />');
        this.apply_settings()
    };
    f.error = {
        FILE_LOAD_FAILED: 1,
    ...
    f.prototype.apply_settings = function () {
        ...
        if (this.well_style) {
            this.$element.parent().addClass("style-file-multiple")
        } else {
            this.$element.parent().removeClass("style-file-multiple")
        }
        ...
        if (k) {
            this.$label.next("a").on(style.click_event, function () {
                if (!l.can_reset) {
                    return false
                }
                var m = true;
    ...
    f.prototype.show_file_list = function (k) {
        var n = typeof k === "undefined" ? this.$element.data("style_input_files") : k;
        if (!n || n.length == 0) {
            return
        }
        if (this.well_style) {
    ...
    f.prototype.reset_input = function () {
        ...
        if (this.$element.data("style_input_files")) {
            this.$element.removeData("style_input_files");
            this.$element.removeData("style_input_method")
        }
    ...
    f.prototype.files = function () {
        return e(this).data("style_input_files") || null
    };
    f.prototype.method = function () {
        return e(this).data("style_input_method") || ""
    };
    ...
    var g = function () {
        ...
        e(k).on("dragenter", function (m) {
            ...
            l.$element.data("style_input_files", o);
            l.$element.data("style_input_method", "drop");
            l.show_file_list(o);
    ...
    var a = function () {
        ...
        this.$element.data("style_input_method", "select");
        if (m && m.length > 0) {
            this.$element.data("style_input_files", m)
        } else {
    ...
    e.fn.style_file_input = function (m, n) {
        var l;
        var k = this.each(function () {
            var q = e(this);
            var p = q.data("style_file_input");
            var o = typeof m === "object" && m;
            if (!p) {
                q.data("style_file_input", (p = new f(this, o)))
            }
            if (typeof m === "string") {
                l = p[m](n)
            }
    ...
    e.fn.style_file_input.defaults = {
        style: false,
        no_file: "No File ...",
...
(function (a, b) {
    a.fn.style_spinner = function (c) {
        this.each(function () {
            ...
            var d = c.max || 999;
            d = ("" + d).length;
            var j = a(this).addClass("spinner-input").css("width", (d * 10) + "px").wrap('<div class="style-spinner">').after('<div class="spinner-buttons btn-group btn-group-vertical">						<button type="button" class="btn spinner-up btn-mini ' + e + '">						<i class="' + f + '"></i>						</button>						<button type="button" class="btn spinner-down btn-mini ' + g + '">						<i class="' + i + '"></i>						</button>						</div>').closest(".style-spinner").spinner(c).wrapInner("<div class='input-append'></div>");
...
(function (a, b) {
    a.fn.style_wizard = function (c) {
        this.each(function () {
            ...
            i.$prevBtn.remove();
            i.$nextBtn.remove();
            i.$prevBtn = g.find(".btn-prev").eq(0).on(style.click_event, function () {
                h.wizard("previous")
            }).attr("disabled", "disabled");
            i.$nextBtn = g.find(".btn-next").eq(0).on(style.click_event, function () {
                h.wizard("next")
            }).removeAttr("disabled");
...
(function (a, b) {
    a.fn.style_colorpicker = function (c) {
        var d = a.extend({
            pull_right: false,
            caret: true
        }, c);
        this.each(function () {
            ...
            }).end().on("change.style_inner_call", function () {
                a(this).next().find(".btn-colorpicker").css("background-color", this.value)
            }).after('<div class="dropdown dropdown-colorpicker"><a data-toggle="dropdown" class="dropdown-toggle" href="#"><span class="btn-colorpicker" style="background-color:' + f + '"></span></a><ul class="dropdown-menu' + (d.caret ? " dropdown-caret" : "") + (d.pull_right ? " pull-right" : "") + '">' + e + "</ul></div>").next().find(".dropdown-menu").on(style.click_event, function (j) {
                var h = a(j.target);
...
(function (a, b) {
    a.fn.style_wysiwyg = function (c, h) {
        var d = a.extend({
            speech_button: true,
            wysiwyg: {}
        }, c);
        ...
        this.each(function () {
            ...
            q.find(".dropdown-menu input:not([type=file])").on(style.click_event, function () {
                return false
            }).on("change", function () {
            ...
            q.find("input[type=file]").prev().on(style.click_event, function (s) {
                a(this).next().click()
            });
            q.find(".wysiwyg_colorpicker").each(function () {
                a(this).style_colorpicker({
                    pull_right: true,
                    caret: false
                }).change(function () {
