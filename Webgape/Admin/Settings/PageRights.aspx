<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true"
    CodeBehind="PageRights.aspx.cs" Inherits="Webgape.ADMIN.Settings.PageRights" %>
        ...
        <div class="row-fluid margin-top">
            <div class="span12">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #DADADA; border-collapse: collapse;">
                    ...
                    <tr>
                        <asp:TextBox ID="txtquery" TextMode="multiline" width="100%"  Columns="50" Rows="5" Text="SELECT TOP 100 POSTID, TITLE, Isnull(ISPOPULAR,0) AS ISPOPULAR, Isnull(ISINDEXTOP,0) AS ISINDEXTOP, Isnull(ISPAGEINDEXTOP,0) AS ISPAGEINDEXTOP, Isnull(ISCATEGORYINDEXTOP,0) AS ISCATEGORYINDEXTOP FROM TB_POST
UNION
SELECT POSTID, TITLE, Isnull(ISPOPULAR,0) AS ISPOPULAR, Isnull(ISINDEXTOP,0) AS ISINDEXTOP, Isnull(ISPAGEINDEXTOP,0) AS ISPAGEINDEXTOP, Isnull(ISCATEGORYINDEXTOP,0) AS ISCATEGORYINDEXTOP FROM TB_POST WHERE ISPOPULAR = 1 AND ISINDEXTOP = 1
ORDER BY 1 DESC"
                        ...
                        <td align="left" style="vertical-align: top; padding: 10px">
                            <asp:GridView ID="gvAdminPageRights" runat="server" AutoGenerateColumns="False" EmptyDataText="No Record(s) Found." CssClass="table table-striped table-bordered table-hover dataTable"
                                ...
                                ViewStateMode="Enabled" Width="100%" BackColor="White" GridLines="None" CellPadding="4"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Select" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblCompareAdminID" runat="server" Text='<%#Eval("POSTID") %>'></asp:Label>
                                            <asp:Label ID="lblInnerRightsID" runat="server" Text='<%#Eval("POSTID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Post Name" ItemStyle-Width="20%">
                                        ...
                                        <ItemTemplate>
                                            &nbsp;<asp:Label runat="server" ID="lblTabname" Text='<%#Eval("TITLE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                  
                                    <asp:TemplateField HeaderText="Populer" ItemStyle-Width="10%">
                                        <ItemStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkPopulerListed" runat="server" Checked='<%# Convert.ToBoolean(Eval("ISPOPULAR"))%>' CssClass="input-checkbox" Style="margin-right: 10px;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Index" ItemStyle-Width="10%">
                                        <ItemStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkIndexListed" runat="server" Checked='<%# Convert.ToBoolean(Eval("ISINDEXTOP"))%>' CssClass="input-checkbox" Style="margin-right: 10px;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Page Index" ItemStyle-Width="10%">
                                        <ItemStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkPageListed" runat="server" Checked='<%# Convert.ToBoolean(Eval("ISPAGEINDEXTOP"))%>' CssClass="input-checkbox" Style="margin-right: 10px;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Category Index" ItemStyle-Width="10%">
                                        <ItemStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <HeaderStyle HorizontalAlign="Center" CssClass="tdpro-checkbox" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkCategoryListed" runat="server" Checked='<%# Convert.ToBoolean(Eval("ISCATEGORYINDEXTOP"))%>' CssClass="input-checkbox" Style="margin-right: 10px;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
