<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PasswordList.aspx.cs" Inherits="Webgape.Admin.PasswordList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Password List</li>
        </ul>
            ...
            <div class="span12">
                <div class="widget-header header-color-dark">
                    <div class="widget-toolbar" style="float: right;">
                        <a href="/Admin/Password.aspx" id="ahmsg" runat="server">
                            <span class="btn btn-small btn-primary" style="width: 105px;">
                                <i class="icon-plus-sign"></i>Add Password</span>
                                            ...
                                            <div class="pagination no-margin right">
                                                <table width="100%" align="right" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="ddlSearch" runat="server" Style="width: 150px;" CssClass="no-margin"
                                                                        ...
                                                                        <asp:ListItem Value="Identifier">Identifier</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span style="float: right;">Total Passwords:
                        ...
                        <table id="sample-table-2" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-top: 0px; padding-bottom: 0px;">
                                    <asp:GridView ID="grdPassword" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                        GridLines="None" EmptyDataText="No Record(s) Found." OnRowCommand="grdPassword_RowCommand"
                                        ...
                                        CellSpacing="1" BorderStyle="solid" BorderWidth="1" BorderColor="#e7e7e7" OnRowDeleting="grdPassword_RowDeleting">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrstatus" runat="server" Text='<%# Eval("Type") %>'></asp:Literal>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="22%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrIdentifier" runat="server" Text='<%# SetName(Convert.ToString(Eval("Identifier")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="21%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrPassword" runat="server" Text='<%# SetName(Convert.ToString(Eval("Password")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="21%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrComment" runat="server" Text='<%# SetName(Convert.ToString(Eval("Comment")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="View" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    <a id="hplView" runat="server" href='<%# "/Admin/Password.aspx?PasswordID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><span class="green"><i class="icon-eye-open bigger-160"></i></span></a>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="btndelUser" ToolTip="Delete" CommandName="delete"
                                                        AlternateText="Delete Message" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Id") %>' message="Are you sure want to delete selected Password ?" OnClientClick='return confirm(this.getAttribute("message"))'>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Password ?', 'Confirmation', function (r) {
                if (r == true) {
