<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CommentList.aspx.cs" Inherits="Webgape.Admin.Posts.CommentList" %>
            ...
            <div class="span12">
                <div class="widget-header header-color-dark">
                    <%--   <div class="widget-toolbar" style="float: right;">
                        <a href="/Admin/Profile/Message.aspx" id="ahmsg" runat="server">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span11">
                                                <div class="span6">
                                                    ...
                                                    <div class="span7">
                                                        <asp:DropDownList ID="ddlEntityType" runat="server" Style="width: 150px;" AutoPostBack="true"
                                                            CssClass="no-margin" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" onchange="javascript:chkHeight();">
                                                            <asp:ListItem>All Entity</asp:ListItem>
                                                            <asp:ListItem Selected="True">Post</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="span6">
                                                    ...
                                                    <div class="span7">
                                                        <asp:DropDownList ID="ddlType" runat="server" Style="width: 150px;" AutoPostBack="true"
                                                            CssClass="no-margin" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" onchange="javascript:chkHeight();">
                                                            <asp:ListItem>All Comment</asp:ListItem>
                                                            <asp:ListItem Selected="True">For Me</asp:ListItem>
                                                            <asp:ListItem>By Me</asp:ListItem>
                                            ...
                                            <div class="pagination no-margin right">
                                                <table width="100%" align="right" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="ddlSearch" runat="server" Style="width: 150px;" CssClass="no-margin"
                                                                        AutoPostBack="true">
                                                                        <asp:ListItem Value="Comments">Comment</asp:ListItem>
                                                                        <asp:ListItem Value="AdminName">Comment By</asp:ListItem>
                                                                        <asp:ListItem Value="EntityIdentifier">Identifier</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span style="float: right;">Total Comment:
                        ...
                        <table id="sample-table-2" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-top: 0px; padding-bottom: 0px;">
                                    <asp:GridView ID="grdComment" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                        ...
                                        CellSpacing="1" BorderStyle="solid" BorderWidth="1" BorderColor="#e7e7e7" OnPageIndexChanging="grd_PageIndexChanging">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrentityfrom" runat="server" Text='<%# SetName(Convert.ToString(Eval("EntityName")))%>'></asp:Literal>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="40%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrmessage" runat="server" Text='<%# SetName(Convert.ToString(Eval("Comments")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                              <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrmessage" runat="server" Text='<%# SetName(Convert.ToString(Eval("AdminName")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="View / Delete" ItemStyle-Width="10%">
                                                <ItemTemplate>
                                                    <a id="hplView" runat="server" href='<%# "/Admin/Posts/Comment.aspx?CommentID="+ DataBinder.Eval(Container.DataItem, "CommentID")%>'><span class="green"><i class="icon-eye-open bigger-160"></i></span></a>
                                                </ItemTemplate>
