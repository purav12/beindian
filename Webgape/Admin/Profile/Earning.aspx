<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Earning.aspx.cs" Inherits="Webgape.Admin.Profile.Earning" %>
                        ...
                        <table id="sample-table-2" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-top: 0px; padding-bottom: 0px;">
                                    <asp:GridView ID="grdEarning" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                        ...
                                        OnRowDataBound="grdEarning_RowDataBound"  OnPageIndexChanging="grd_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="50%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrto" runat="server" Text='<%# SetName(Convert.ToString(Eval("Money")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
