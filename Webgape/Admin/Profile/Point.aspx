<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Point.aspx.cs" Inherits="Webgape.Admin.Profile.Point" %>
                                            ...
                                            <div class="pagination no-margin right">
                                                <table width="100%" align="right" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span style="float: right;">Total Record:
                        ...
                        <table id="sample-table-2" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-top: 0px; padding-bottom: 0px;">
                                    <asp:GridView ID="grdPoint" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                        ...
                                        OnRowDataBound="grdPoint_RowDataBound" OnPageIndexChanging="grd_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="60%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrto" runat="server" Text='<%# SetName(Convert.ToString(Eval("Text")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="7%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrfrom" runat="server" Text='<%# SetName(Convert.ToString(Eval("Point")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <%# String.Format("{0:MM/dd/yyyy}", Eval("LastUpdated"))%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                        </Columns>
