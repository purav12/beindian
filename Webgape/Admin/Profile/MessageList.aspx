<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="MessageList.aspx.cs" Inherits="Webgape.Admin.Profile.MessageList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="span12">
                <div class="widget-header header-color-dark">
                    <div class="widget-toolbar" style="float: right;">
                        <a href="/Admin/Users/UserList.aspx" id="ahmsg" runat="server">
                                        ...
                                        <div class="row-fluid">
                                            <span>&nbsp;</span> Type :
                                             <asp:DropDownList ID="ddlType" runat="server" Style="width: 150px;" AutoPostBack="true"
                                                 ...
                                                 <asp:ListItem Selected="True">All Message</asp:ListItem>
                                            ...
                                            <div class="pagination no-margin right">
                                                <table width="100%" align="right" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="ddlSearch" runat="server" Style="width: 150px;" CssClass="no-margin"
                                                                        AutoPostBack="true">
                                                                        <asp:ListItem Value="MessageFrom">Message From</asp:ListItem>
                                                                        <asp:ListItem Value="MessageTo">Message To</asp:ListItem>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span style="float: right;">Total Messages:
                        ...
                        <table id="sample-table-2" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding-top: 0px; padding-bottom: 0px;">
                                    <asp:GridView ID="grdMessage" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                        GridLines="None" EmptyDataText="No Record(s) Found." OnRowCommand="grdMessage_RowCommand"
                                        ...
                                        OnRowDataBound="grdMessage_RowDataBound" OnPageIndexChanging="grd_PageIndexChanging"
                                        CellSpacing="1" BorderStyle="solid" BorderWidth="1" BorderColor="#e7e7e7" OnRowDeleting="grdMessage_RowDeleting">
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hdnMsgid" runat="server" Value='<%#Eval("Id") %>' />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="hdnFrmid" runat="server" Value='<%#Eval("FromId") %>' />
                                                    <asp:Literal ID="ltrfrom" runat="server" Text='<%# SetName(Convert.ToString(Eval("MessageFrom")))%>'></asp:Literal>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="10%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="hdnToid" runat="server" Value='<%#Eval("ToId") %>' />
                                                    <asp:Literal ID="ltrto" runat="server" Text='<%# SetName(Convert.ToString(Eval("MessageTo")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="50%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Literal ID="ltrmessage" runat="server" Text='<%# SetName(Convert.ToString(Eval("Message")))%>'></asp:Literal>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="9%">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcreatedon" runat="server" Text='<%# Bind("SentOn","{0:MM/dd/yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Edit / View" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    <a id="hplView" runat="server" href='<%# "/Admin/Profile/Message.aspx?MessageID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><span class="green"><i class="icon-eye-open bigger-160"></i></span></a>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="7%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="btndelUser" ToolTip="Delete" CommandName="delete"
                                                        AlternateText="Delete Message" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"Id") %>' message="Are you sure want to delete selected Message ?" OnClientClick='return confirm(this.getAttribute("message"))'>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function checkaa() {
            jConfirm('Are you sure want to delete all selected Message ?', 'Confirmation', function (r) {
                if (r == true) {
